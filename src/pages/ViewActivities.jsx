...
import { faUtensils, faBaby, faCapsules, faSun } from "@fortawesome/free-solid-svg-icons";
...
export function ViewActivities() {
  ...
  const renderActivityTime = (activityName, activityTime) => {
    ...
    return (
      ...
      >
        {activityDate.toLocaleTimeString(undefined, { weekday: 'short', year: 'numeric', month: 'short', day: 'numeric' })}
      </div>
    );
  };
  ...
  const renderActivityIcon = (activityName) => {
    ...
    switch (activityName) {
      case "Feed":
        return <FontAwesomeIcon color={iconColor} icon={faUtensils} className="h-6 w-6" />;
      case "Diaper":
        return <FontAwesomeIcon color={iconColor} icon={faBaby} className="h-6 w-6" />;
      case "Vitamin D":
        return <FontAwesomeIcon color={iconColor} icon={faSun} className="h-6 w-6" />;
      case "Medicine":
        return <FontAwesomeIcon color={iconColor} icon={faCapsules} className="h-6 w-6" />;
      default:
        return null;
    }
  };
    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      <section className="mt-12">
        ...
        <div className="bg-white shadow-md rounded m-4">
          {activities.current.sort((a, b) => new Date(b.activityTime) - new Date(a.activityTime)).map((activity) => (
            <div
            ...
            >
              <div className="w-full sm:w-1/4 px-6 mb-4 sm:mb-0">
                ...
                {renderActivityIcon(activity.activityName)} {activity.activityName}
                </p>
              </div>
              ...
              <div className="w-full sm:w-1/4 px-6 mb-4 sm:mb-0">
                <h4 className="hidden md:flex font-bold uppercase text-sm text-grey">Time</h4>
                <p className="">
                  {renderActivityTime(
